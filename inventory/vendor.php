...
<body>
    ...
    <img src="image/clo.jpg" onclick="hideMenu()"> 
        ...
        <a href="vendor.php" class="active">Register Vendor</a>
...
<input type="text" class="name" name="name" placeholder="Vendor Name"> <br>
<input type="text" class="email" name="email" placeholder="Vendor Email">
...
<select class="region" name="region">
    <option disable selection>Choose Region </option>
...
<?php
        if(isset($_POST['submit'])){
            ...
            $select="INSERT INTO vendors VALUES('','$name','$email','$addres','$name1','$name2','$name3','$location','$district','$region')";
